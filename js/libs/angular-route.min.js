...
(function(C, d) {
    ...
    var w = d.module("ngRoute", ["ng"]).provider("$route", function() {
            function r(a,
                c) {
            ...
            this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$templateRequest",
                "$sce",
                function(a, c, b, f, h, k, x) {
                    function l(b) {
                        var e = s.current;
                        (w = (p = n()) && e && p.$$route === e.$$route && d.equals(p.pathParams, e.pathParams) && !p.reloadOnSearch && !u) || !e && !p || a.$broadcast("$routeChangeStart", p, e).defaultPrevented && b && b.preventDefault()
                    }
                    ...
                    function m() {
                        ...
                        if (w) v.params = e.params, d.copy(v.params, b), a.$broadcast("$routeUpdate", v);
                        else if (e || v) u = !1, (s.current = e) && e.redirectTo && (d.isString(e.redirectTo) ? c.path(t(e.redirectTo, e.params)).search(e.params).replace() : c.url(e.redirectTo(e.pathParams,
                            ...
                            if (e) {
                                ...
                                d.isDefined(b = e.template) ? d.isFunction(b) && (b = b(e.params)) : d.isDefined(c = e.templateUrl) && (d.isFunction(c) && (c = c(e.params)), d.isDefined(c) && (e.loadedTemplateUrl = x.valueOf(c), b = k(c)));
                            ...
                            e == s.current && a.$broadcast("$routeChangeError", e, v, b)
                        })
                    }
                    ...
                    var u = !1,
                        p, w, s = {
                            ...
                            updateParams: function(a) {
                                if (this.current && this.current.$$route) a = d.extend({}, this.current.params, a), c.path(t(this.current.$$route.originalPath, a)), c.search(a);
                                else throw B("norout");
                            }
                        };
        ...
        B = d.$$minErr("ngRoute");
    w.provider("$routeParams", function() {
        this.$get = function() {
            return {}
        }
    });
    w.directive("ngView", z);
    w.directive("ngView", A);
    z.$inject = ["$route", "$anchorScroll", "$animate"];
